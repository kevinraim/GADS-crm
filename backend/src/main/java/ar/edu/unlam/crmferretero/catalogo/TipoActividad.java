...
@Document("tipos_actividad")
public class TipoActividad extends BaseDocument {
    ...
    public TipoActividad(String nombre, int orden, boolean activo, String distribuidoraId) {
        this.nombre = nombre;
        this.orden = orden;
        this.activo = activo;
